...
$a_plus_query = "SELECT SUM(blood_quantity-dispatch_units) AS total_units FROM blood_inventory WHERE blood_type = 'A+'";
...
// Query for A- blood type units
$a_minus_query = "SELECT SUM(blood_quantity-dispatch_units) AS total_units FROM blood_inventory WHERE blood_type = 'A-'";
...
$b_plus_query = "SELECT SUM(blood_quantity-dispatch_units) AS total_units FROM blood_inventory WHERE blood_type = 'B+'";
...
// Query for B- blood type units
$b_minus_query = "SELECT SUM(blood_quantity-dispatch_units) AS total_units FROM blood_inventory WHERE blood_type = 'B-'";
...
$ab_plus_query = "SELECT SUM(blood_quantity-dispatch_units) AS total_units FROM blood_inventory WHERE blood_type = 'AB+'";
...
// Query for AB- blood type units
$ab_minus_query = "SELECT SUM(blood_quantity-dispatch_units) AS total_units FROM blood_inventory WHERE blood_type = 'AB-'";
...
$o_plus_query = "SELECT SUM(blood_quantity-dispatch_units) AS total_units FROM blood_inventory WHERE blood_type = 'O+'";
...
// Query for O- blood type units
$o_minus_query = "SELECT SUM(blood_quantity-dispatch_units) AS total_units FROM blood_inventory WHERE blood_type = 'O-'";
